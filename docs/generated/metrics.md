...
| LithosClient | 3 | 1812 | 1480 | 2 | 5 | 0.71 | 20 (`lithos_lens.fake_lithos.FakeLithosClient.list_tasks`) | 4 |
...
| Web | 1 | 604 | 502 | 1 | 8 | 0.89 | 11 (`lithos_lens.web.create_app.note`) | 1 |

## Size

- Modules: **28**, lines: **7836**, SLOC: **6180**
...
- Test-to-source line ratio: **1.82** (14254 test lines / 7836 source lines)
