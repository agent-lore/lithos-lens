...
| LithosClient | 1 | 518 | 437 | 2 | 2 | 0.50 | 8 (`lithos_lens.lithos_client.LithosClient.list_tasks`) | 0 |
...
| Tasks | 1 | 766 | 621 | 3 | 0 | 0.00 | 23 (`lithos_lens.tasks.normalize_task`) | 5 |
...
- Modules: **13**, lines: **2743**, SLOC: **2282**
- Largest module: `lithos_lens.tasks` (766 lines)
- Modules over 800 lines: **0**

## Complexity

- Functions: **138**, cyclomatic > 10: **6**
...
- Test-to-source line ratio: **1.58** (4332 test lines / 2743 source lines)
