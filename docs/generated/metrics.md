...
| Entrypoint | 2 | 87 | 54 | 0 | 4 | 1.00 | 4 (`lithos_lens.main.resolve_port`) | 0 |
...
| LithosClient | 3 | 1843 | 1511 | 2 | 5 | 0.71 | 20 (`lithos_lens.fake_lithos.FakeLithosClient.list_tasks`) | 4 |
...
| TaskGraph | 8 | 2740 | 2081 | 2 | 1 | 0.33 | 42 (`lithos_lens.frontier.load_dashboard`) | 3 |
...
| Web | 1 | 587 | 500 | 1 | 8 | 0.89 | 11 (`lithos_lens.web.create_app.note`) | 1 |

## Size

- Modules: **29**, lines: **8704**, SLOC: **6823**
- Largest module: `lithos_lens.lithos_client` (870 lines)
- Modules over 800 lines: **1**
  - `lithos_lens.lithos_client`

## Complexity

- Functions: **334**, cyclomatic > 10: **14**
...
- Domain models: **36** (39 associations, 14 without docstrings)
- Test-to-source line ratio: **1.74** (15128 test lines / 8704 source lines)
