...
| LithosClient | 3 | 1770 | 1460 | 2 | 5 | 0.71 | 20 (`lithos_lens.fake_lithos.FakeLithosClient.list_tasks`) | 4 |
...
| TaskGraph | 8 | 2340 | 1801 | 2 | 1 | 0.33 | 42 (`lithos_lens.frontier.load_dashboard`) | 3 |
...
- Modules: **29**, lines: **8177**, SLOC: **6460**
...
- Functions: **313**, cyclomatic > 10: **14**
...
- Domain models: **37** (37 associations, 14 without docstrings)
- Test-to-source line ratio: **1.77** (14514 test lines / 8177 source lines)
