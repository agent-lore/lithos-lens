...
- Cross-component edges: **24** (28 module-level)
...
| LithosClient | 2 | 942 | 800 | 2 | 4 | 0.67 | 16 (`lithos_lens.fake_lithos.FakeLithosClient.list_tasks`) | 1 |
...
| Web | 1 | 318 | 284 | 1 | 6 | 0.86 | 8 (`lithos_lens.web.create_app.note`) | 0 |

## Size

- Modules: **15**, lines: **3607**, SLOC: **2996**
- Largest module: `lithos_lens.config` (725 lines)
- Modules over 800 lines: **0**

## Complexity

- Functions: **173**, cyclomatic > 10: **8**
...
| 10 | `lithos_lens.fake_lithos.FakeLithosClient.task_children` |
...
- Test-to-source line ratio: **1.48** (5341 test lines / 3607 source lines)
