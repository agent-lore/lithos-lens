...
| TaskGraph | 2 | 547 | 434 | 2 | 1 | 0.33 | 25 (`lithos_lens.frontier.load_dashboard`) | 2 |
| Tasks | 1 | 540 | 421 | 5 | 0 | 0.00 | 23 (`lithos_lens.tasks.normalize_task`) | 3 |
...
- Test-to-source line ratio: **1.54** (7818 test lines / 5073 source lines)
