...
| TaskGraph | 6 | 1736 | 1331 | 2 | 1 | 0.33 | 42 (`lithos_lens.frontier.load_dashboard`) | 3 |
| Tasks | 4 | 1198 | 897 | 5 | 0 | 0.00 | 23 (`lithos_lens.normalizers.normalize_task`) | 3 |
| Telemetry | 1 | 29 | 20 | 1 | 1 | 0.50 | 2 (`lithos_lens.telemetry.install_request_middleware.lens_request`) | 0 |
| Web | 1 | 545 | 473 | 1 | 8 | 0.89 | 11 (`lithos_lens.web.create_app.note`) | 1 |

## Size

- Modules: **28**, lines: **7730**, SLOC: **6128**
...
- Functions: **301**, cyclomatic > 10: **14**
...
- Test-to-source line ratio: **1.80** (13885 test lines / 7730 source lines)
