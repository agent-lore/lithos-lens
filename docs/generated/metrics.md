...
| TaskGraph | 2 | 999 | 772 | 2 | 1 | 0.33 | 33 (`lithos_lens.frontier.load_dashboard`) | 3 |
| Tasks | 2 | 918 | 694 | 5 | 0 | 0.00 | 23 (`lithos_lens.tasks.normalize_task`) | 3 |
...
- Modules: **22**, lines: **6613**, SLOC: **5296**
- Largest module: `lithos_lens.frontier` (880 lines)
...
- Test-to-source line ratio: **1.81** (11958 test lines / 6613 source lines)
