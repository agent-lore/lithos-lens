...
| LithosClient | 3 | 1814 | 1482 | 2 | 5 | 0.71 | 20 (`lithos_lens.fake_lithos.FakeLithosClient.list_tasks`) | 4 |
...
| Web | 1 | 857 | 688 | 1 | 8 | 0.89 | 12 (`lithos_lens.web._parse_preserved_filters`) | 2 |

## Size

- Modules: **28**, lines: **8231**, SLOC: **6438**
...
- Functions: **309**, cyclomatic > 10: **15**
...
- Test-to-source line ratio: **1.87** (15413 test lines / 8231 source lines)
