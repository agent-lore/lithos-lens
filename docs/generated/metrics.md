...
|---|---:|---:|---:|---:|---:|---:|---|---:|
| Config | 1 | 704 | 601 | 7 | 2 | 0.22 | 23 (`lithos_lens.config._apply_env_overrides`) | 1 |
...
| Knowledge | 1 | 365 | 288 | 2 | 1 | 0.33 | 9 (`lithos_lens.knowledge._normalize_edges`) | 0 |
...
- Modules: **14**, lines: **3123**, SLOC: **2582**
- Largest module: `lithos_lens.config` (704 lines)
...
- Test-to-source line ratio: **1.54** (4802 test lines / 3123 source lines)
