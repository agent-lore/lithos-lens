...
| Knowledge | 2 | 917 | 701 | 2 | 1 | 0.33 | 13 (`lithos_lens.knowledge._gather_candidates`) | 2 |
| LithosClient | 3 | 1502 | 1262 | 2 | 5 | 0.71 | 16 (`lithos_lens.fake_lithos.FakeLithosClient.list_tasks`) | 3 |
...
| Web | 1 | 486 | 423 | 1 | 8 | 0.89 | 11 (`lithos_lens.web.create_app.note`) | 1 |

## Size

- Modules: **18**, lines: **5365**, SLOC: **4361**
- Largest module: `lithos_lens.config` (797 lines)
- Modules over 800 lines: **0**

## Complexity

- Functions: **236**, cyclomatic > 10: **13**
...
- Test-to-source line ratio: **1.67** (8985 test lines / 5365 source lines)
