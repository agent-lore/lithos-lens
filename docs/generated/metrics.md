...
- Cross-component edges: **27** (53 module-level)
...
| LithosClient | 3 | 1814 | 1491 | 2 | 5 | 0.71 | 20 (`lithos_lens.fake_lithos.FakeLithosClient.list_tasks`) | 4 |
...
| TaskGraph | 7 | 2477 | 1909 | 2 | 1 | 0.33 | 42 (`lithos_lens.frontier.load_dashboard`) | 3 |
...
| Web | 1 | 548 | 470 | 1 | 8 | 0.89 | 11 (`lithos_lens.web.create_app.note`) | 1 |

## Size

- Modules: **28**, lines: **8360**, SLOC: **6599**
- Largest module: `lithos_lens.lithos_client` (841 lines)
- Modules over 800 lines: **1**
  - `lithos_lens.lithos_client`

## Complexity

- Functions: **325**, cyclomatic > 10: **14**
...
- Test-to-source line ratio: **1.75** (14649 test lines / 8360 source lines)
