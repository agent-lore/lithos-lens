...
- Cross-component edges: **33** (70 module-level)
...
| Events | 1 | 696 | 506 | 3 | 3 | 0.50 | 14 (`lithos_lens.events._iter_sse_lines`) | 2 |
| Knowledge | 4 | 1099 | 836 | 2 | 1 | 0.33 | 13 (`lithos_lens.knowledge_resolver._gather_candidates`) | 2 |
| LithosClient | 4 | 2191 | 1746 | 2 | 6 | 0.75 | 20 (`lithos_lens.fake_lithos.FakeLithosClient.list_tasks`) | 4 |
...
| Telemetry | 2 | 868 | 644 | 4 | 2 | 0.33 | 10 (`lithos_lens.telemetry.setup_telemetry`) | 0 |
| Web | 2 | 1141 | 891 | 1 | 9 | 0.90 | 14 (`lithos_lens.request_filters._parse_preserved_filters`) | 2 |

## Size

- Modules: **36**, lines: **12400**, SLOC: **9491**
- Largest module: `lithos_lens.web` (788 lines)
- Modules over 800 lines: **0**

## Complexity

- Functions: **429**, cyclomatic > 10: **19**
...
- Test-to-source line ratio: **1.89** (23431 test lines / 12400 source lines)
