...
| TaskGraph | 2 | 862 | 661 | 2 | 1 | 0.33 | 31 (`lithos_lens.frontier.load_dashboard`) | 3 |
| Tasks | 1 | 634 | 488 | 5 | 0 | 0.00 | 23 (`lithos_lens.tasks.normalize_task`) | 3 |
...
- Test-to-source line ratio: **1.77** (10623 test lines / 5998 source lines)
