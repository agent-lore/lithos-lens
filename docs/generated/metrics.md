...
| Tasks | 4 | 1255 | 926 | 5 | 0 | 0.00 | 23 (`lithos_lens.normalizers.normalize_task`) | 3 |
| Telemetry | 1 | 29 | 20 | 1 | 1 | 0.50 | 2 (`lithos_lens.telemetry.install_request_middleware.lens_request`) | 0 |
| Web | 1 | 585 | 508 | 1 | 8 | 0.89 | 11 (`lithos_lens.web.create_app.note`) | 1 |

## Size

- Modules: **28**, lines: **7794**, SLOC: **6167**
...
- Functions: **300**, cyclomatic > 10: **14**
...
- Test-to-source line ratio: **1.83** (14278 test lines / 7794 source lines)
