...
| Tasks | 4 | 1300 | 947 | 5 | 0 | 0.00 | 23 (`lithos_lens.normalizers.normalize_task`) | 3 |
| Telemetry | 1 | 29 | 20 | 1 | 1 | 0.50 | 2 (`lithos_lens.telemetry.install_request_middleware.lens_request`) | 0 |
| Web | 1 | 772 | 649 | 1 | 8 | 0.89 | 12 (`lithos_lens.web._parse_preserved_filters`) | 2 |

## Size

- Modules: **28**, lines: **8069**, SLOC: **6349**
...
- Functions: **306**, cyclomatic > 10: **15**
...
- Test-to-source line ratio: **1.86** (15026 test lines / 8069 source lines)
