...
- Cross-component edges: **35** (115 module-level)
...
| TaskGraph | 23 | 10839 | 8290 | 4 | 1 | 0.20 | 40 (`lithos_lens.frontier.load_dashboard`) | 24 |
| Tasks | 6 | 1877 | 1349 | 5 | 0 | 0.00 | 23 (`lithos_lens.normalizers.normalize_task`) | 6 |
| Telemetry | 2 | 1116 | 814 | 4 | 2 | 0.33 | 10 (`lithos_lens.telemetry.setup_telemetry`) | 0 |
| Web | 4 | 2230 | 1726 | 1 | 9 | 0.90 | 14 (`lithos_lens.request_filters._parse_preserved_filters`) | 2 |

## Size

- Modules: **54**, lines: **22184**, SLOC: **16942**
- Largest module: `lithos_lens.tasks` (845 lines)
...
- Test-to-source line ratio: **2.04** (45270 test lines / 22184 source lines)
