...
| LithosClient | 3 | 1832 | 1498 | 2 | 5 | 0.71 | 20 (`lithos_lens.fake_lithos.FakeLithosClient.list_tasks`) | 4 |
...
| TaskGraph | 8 | 2697 | 2061 | 2 | 1 | 0.33 | 42 (`lithos_lens.frontier.load_dashboard`) | 3 |
...
| Web | 1 | 568 | 486 | 1 | 8 | 0.89 | 11 (`lithos_lens.web.create_app.note`) | 1 |

## Size

- Modules: **29**, lines: **8618**, SLOC: **6774**
- Largest module: `lithos_lens.lithos_client` (859 lines)
...
- Test-to-source line ratio: **1.72** (14841 test lines / 8618 source lines)
