...
| TaskGraph | 2 | 765 | 589 | 2 | 1 | 0.33 | 28 (`lithos_lens.frontier.load_dashboard`) | 3 |
| Tasks | 1 | 706 | 552 | 5 | 0 | 0.00 | 23 (`lithos_lens.tasks.normalize_task`) | 3 |
...
- Test-to-source line ratio: **1.78** (10651 test lines / 5988 source lines)
