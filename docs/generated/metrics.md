...
- Cross-component edges: **35** (94 module-level)
...
| TaskGraph | 18 | 7737 | 5928 | 4 | 1 | 0.20 | 46 (`lithos_lens.frontier.load_dashboard`) | 17 |
| Tasks | 3 | 1128 | 817 | 5 | 0 | 0.00 | 23 (`lithos_lens.normalizers.normalize_task`) | 3 |
| Telemetry | 2 | 1091 | 793 | 4 | 2 | 0.33 | 10 (`lithos_lens.telemetry.setup_telemetry`) | 0 |
| Web | 4 | 1576 | 1230 | 1 | 9 | 0.90 | 14 (`lithos_lens.request_filters._parse_preserved_filters`) | 2 |

## Size

- Modules: **46**, lines: **17553**, SLOC: **13469**
- Largest module: `lithos_lens.graph_layout` (799 lines)
- Modules over 800 lines: **0**

## Complexity

- Functions: **581**, cyclomatic > 10: **31**
...
- Domain models: **69** (78 associations, 16 without docstrings)
- Test-to-source line ratio: **1.69** (29585 test lines / 17553 source lines)
