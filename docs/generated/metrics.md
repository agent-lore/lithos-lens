...
| LithosClient | 3 | 1784 | 1472 | 2 | 5 | 0.71 | 20 (`lithos_lens.fake_lithos.FakeLithosClient.list_tasks`) | 4 |
...
| TaskGraph | 7 | 2342 | 1799 | 2 | 1 | 0.33 | 42 (`lithos_lens.frontier.load_dashboard`) | 3 |
...
| Web | 1 | 546 | 470 | 1 | 8 | 0.89 | 11 (`lithos_lens.web.create_app.note`) | 1 |

## Size

- Modules: **28**, lines: **8193**, SLOC: **6470**
...
- Functions: **320**, cyclomatic > 10: **14**
...
- Domain models: **36** (38 associations, 14 without docstrings)
- Test-to-source line ratio: **1.76** (14402 test lines / 8193 source lines)
