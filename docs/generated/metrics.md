...
|---|---:|---:|---:|---:|---:|---:|---|---:|
| Config | 1 | 696 | 596 | 7 | 2 | 0.22 | 23 (`lithos_lens.config._apply_env_overrides`) | 1 |
...
| Knowledge | 1 | 332 | 259 | 2 | 1 | 0.33 | 9 (`lithos_lens.knowledge._normalize_edges`) | 0 |
...
- Modules: **14**, lines: **3082**, SLOC: **2548**
- Largest module: `lithos_lens.config` (696 lines)
- Modules over 800 lines: **0**

## Complexity

- Functions: **153**, cyclomatic > 10: **6**
...
- Test-to-source line ratio: **1.51** (4664 test lines / 3082 source lines)
