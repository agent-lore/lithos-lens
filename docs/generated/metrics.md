...
| TaskGraph | 2 | 772 | 599 | 2 | 1 | 0.33 | 30 (`lithos_lens.frontier.load_dashboard`) | 3 |
| Tasks | 1 | 622 | 481 | 5 | 0 | 0.00 | 23 (`lithos_lens.tasks.normalize_task`) | 3 |
| Telemetry | 1 | 29 | 20 | 1 | 1 | 0.50 | 2 (`lithos_lens.telemetry.install_request_middleware.lens_request`) | 0 |
| Web | 1 | 507 | 438 | 1 | 8 | 0.89 | 11 (`lithos_lens.web.create_app.note`) | 1 |

## Size

- Modules: **19**, lines: **5883**, SLOC: **4756**
- Largest module: `lithos_lens.config` (797 lines)
- Modules over 800 lines: **0**

## Complexity

- Functions: **251**, cyclomatic > 10: **14**

Top 10 most complex functions:

| Complexity | Function |
|---:|---|
| 30 | `lithos_lens.frontier.load_dashboard` |
...
- Test-to-source line ratio: **1.75** (10277 test lines / 5883 source lines)
