...
- def `row_project_chips` — The project a board ROW states for itself, leading its chips (§5.4.1).
- def `row_tag_chips` — The tags a board row renders beside its project chip, in order (§5.4.1).
...
### `lithos_lens.template_vocabulary`
